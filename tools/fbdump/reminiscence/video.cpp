...
/* fbdump: sprite blit trace hook (added for the SMS port, GPL) */
SpriteHookProc g_spriteHook = 0;
...
void Video::drawSpriteSub1(const uint8_t *src, uint8_t *dst, int pitch, int h, int w, uint8_t colMask) {
	if (g_spriteHook) g_spriteHook(1, src, (int)(dst - _frontLayer), pitch, h, w, colMask); /* fbdump trace hook */
...
void Video::drawSpriteSub2(const uint8_t *src, uint8_t *dst, int pitch, int h, int w, uint8_t colMask) {
	if (g_spriteHook) g_spriteHook(2, src, (int)(dst - _frontLayer), pitch, h, w, colMask); /* fbdump trace hook */
...
void Video::drawSpriteSub3(const uint8_t *src, uint8_t *dst, int pitch, int h, int w, uint8_t colMask) {
	if (g_spriteHook) g_spriteHook(3, src, (int)(dst - _frontLayer), pitch, h, w, colMask); /* fbdump trace hook */
...
void Video::drawSpriteSub4(const uint8_t *src, uint8_t *dst, int pitch, int h, int w, uint8_t colMask) {
	if (g_spriteHook) g_spriteHook(4, src, (int)(dst - _frontLayer), pitch, h, w, colMask); /* fbdump trace hook */
...
void Video::drawSpriteSub5(const uint8_t *src, uint8_t *dst, int pitch, int h, int w, uint8_t colMask) {
	if (g_spriteHook) g_spriteHook(5, src, (int)(dst - _frontLayer), pitch, h, w, colMask); /* fbdump trace hook */
...
void Video::drawSpriteSub6(const uint8_t *src, uint8_t *dst, int pitch, int h, int w, uint8_t colMask) {
	if (g_spriteHook) g_spriteHook(6, src, (int)(dst - _frontLayer), pitch, h, w, colMask); /* fbdump trace hook */
