...
/* fbdump trace hook: variant 1..6 = Video::drawSpriteSubN */
typedef void (*SpriteHookProc)(int variant, const uint8_t *src, int dstOffset, int pitch, int h, int w, uint8_t colMask);
extern SpriteHookProc g_spriteHook;
struct SystemStub;
